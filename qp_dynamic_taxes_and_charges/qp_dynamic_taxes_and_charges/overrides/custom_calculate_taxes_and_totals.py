...
class custom_calculate_taxes_and_totals(calculate_taxes_and_totals):
    ...
    def _get_tax_rate(self, tax, item_tax_map):
        ...
        impuesto_individual_compras = frappe.db.get_single_value('Dynamic Taxes Config', "impuesto_individual_en_compras")

        if tax.account_head in item_tax_map:
            if impuesto_individual and (True if impuesto_individual_compras else  self.doc.doctype not in ["Purchase Invoice", "Purchase Order", "Purchase Receipt"]):
